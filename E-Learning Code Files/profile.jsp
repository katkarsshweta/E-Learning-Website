...
<%@ page language="java" %>
    <p>Your name is: <%= session.getAttribute("userName") %></p>
...
<section class="user-profile">
   ...
   <div class="info">
      ...
      <div class="user">
         <img src="abt7.jpeg" alt="">
         <h3><%= session.getAttribute("userName") %></h3>
         
         
         <p>student</p>
            <a href="logout.jsp" class="inline-btn">Logout</a> <!-- Add a logout link if needed -->
      ...
      <div class="box-container">
         ...
         <div class="box">
            ...
            <a href="saved-playlist.jsp" class="inline-btn">view playlists</a>
         </div>
         ...
         <div class="box">
            ...
            <a href="watch-video.jsp#likes-info" class="inline-btn">view liked</a>
         </div>
