...
<form action="feedback.jsp" method="post">
    ...
    <input type="tel" placeholder="Enter your number" name="number" required maxlength="15" class="box">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <a href="mailto:ashlesha.kagane@cumminscollege.in">ashlesha@gmail.com</a>
         <a href="mailto:pranjal.mogdul@cumminscollege.in">pranjal@gmail.com</a>
      </div>

      <div class="box">
         <i class="fas fa-map-marker-alt"></i>
         <h3>office address</h3>
         <a href="#">CCOEW Centre of Engineering,Karve Nagar,Pune-411052 </a>
      </div>
