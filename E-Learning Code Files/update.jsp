...
<section class="form-container">
    ...
    <form action="updateprofile.jsp" method="post" enctype="multipart/form-data">
        ...
        <p>Update Name</p>
        <input type="text" name="name" placeholder="Ashlesha Kagane" maxlength="50" class="box" value="<%= session.getAttribute("userName") %>">
        <p>Update Email</p>
        <input type="email" name="email" placeholder="ashlesha@gmail.com" maxlength="50" class="box" value="<%= session.getAttribute("userEmail") %>">
        <p>Previous Password</p>
        <input type="password" name="old_pass" placeholder="Enter your password" maxlength="20" class="box">
        <p>New Password</p>
        <input type="password" name="password" placeholder="Confirm your new password" maxlength="20" class="box" value=<%= session.getAttribute("userEmail") %>">
